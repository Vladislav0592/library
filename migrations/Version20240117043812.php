 ...
 */
final class Version20240117043812 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE authors_to_book (book_id INT NOT NULL, author_id INT NOT NULL, UNIQUE INDEX UNIQ_D3160881F675F31B (author_id), INDEX IDX_D316088116A2B381 (book_id), PRIMARY KEY(book_id, author_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
